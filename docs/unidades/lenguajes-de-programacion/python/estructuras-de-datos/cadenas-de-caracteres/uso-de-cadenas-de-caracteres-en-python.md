...
* **isalnum()**,
* **isalpha()**, 
* **isdigit()**: En Python, las cadenas tienen varios métodos útiles para detectar tipos de datos.
...
!!! success "¡Bienvenidas las _f-strings_!"
    ...
    Te vas a ahorrar muchos dolores de cabeza a la hora de concatenar diferentes tipos de datos a la hora de mostrar información en pantalla o crear una cadena de texto para utilizarla en expresiones o almacenarla en una variable, por ejemplo.
