...
Cuando se escribe un programa, se están escribiendo sentencias (recuerda que son instrucciones o declaraciones) en un archivo. Sin sentencias de control de flujo, el programa se ejecuta en el orden en que aparecen escritas las sentencias en el archivo, de izquierda a derecha y de arriba a abajo. 
...
Ejercicio de aplicación:
    ...
    Ver resultado (1)
        ...
        > Esto permite "mezclar" distintos tipos de datos entre si, porque en realidad no se está mezclando nada.  
        > Si en lugar de utilizar la coma se hubiera utilizado el operador de concatenación, se tendría que haber compatibilizado todos los tipos de datos como cadenas:
