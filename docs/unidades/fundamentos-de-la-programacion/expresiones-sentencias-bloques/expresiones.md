...
## Expresiones compuestas, tipo de dato y precedencia de operadores

Cada lenguaje de programación permite construir expresiones compuestas y sentencias a partir de varias expresiones más pequeñas siempre que el tipo de dato requerido por una parte de la expresión coincida con el tipo de dato de la otra. He aquí un ejemplo de una expresión compuesta:
...
!!! question "¡Recordemos, pensemos!" 
    ...
    Aplicando la jerarquía estándar de operadores (revisa la tabla de jerarquías si no la ¡Para recordar!s o tienes dudas).
...
Algunas operaciones se llevan a cabo de manera directa y otras mediante una conversión (casting) implícita de los tipos de dato, si es necesario, dependiendo de las reglas del lenguaje específico. 
...
!!! success "¡Importante!"
    Es importante tener en cuenta que estos operadores se pueden utilizar con diferentes tipos de dato, valores numéricos o expresiones válidas que el lenguaje de programación permita. 

    Por ejemplo, en Python, se puede utilizar con números, cadenas de caracteres y listas, entre otros tipos de dato.
